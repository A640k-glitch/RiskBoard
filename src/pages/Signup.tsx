    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md border border-[var(--border)] bg-[var(--bg-surface)] p-10 relative rounded-3xl shadow-2xl z-10 backdrop-blur-sm">
        ...
        <div className="mb-10 text-center">
          <p className="font-mono text-[var(--accent)] text-xs mb-3 uppercase tracking-widest">// SYSTEM.REGISTER</p>
          <h1 className="text-4xl font-bold font-sans text-[var(--text-primary)] tracking-tight">Create Account</h1>
          <p className="text-[var(--text-muted)] mt-4 font-sans leading-relaxed text-lg">
            Initialize your profile to start tracking portfolio risk and exposure.
          </p>
        </div>
        ...
        >
          <ChevronRight className="w-6 h-6" /> Register with Google
        </button>
